...
<div class="hero">
    ...
    <div class="strip">
        <div class="wrap">
            ...
            <a class="phone" href="tel:263783885678">
...
window.__BOOT__ = {
    ...
    /*
     * Force the asset base to HTTPS.
     * This prevents Laravel/Railway from generating HTTP
     * asset URLs when the site itself is HTTPS.
     */
    assetBase: @json(secure_asset('')),

    api: {
        availability: @json(secure_url(route('api.availability', [], false))),

        bookings: @json(secure_url(route('api.bookings', [], false))),

        status: @json(secure_url(route('api.status', [], false)))
    }
};
</script>
