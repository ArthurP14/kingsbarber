...
<link href="https://fonts.googleapis.com/css2?family=Archivo:wdth,wght@62..125,400..900&family=DM+Sans:wght@400;500;600;700&display=swap" rel="stylesheet">
...
<div class="hero">
    <div class="fade" aria-hidden="true"><i></i><i></i><i></i></div>
    <div class="wrap main">
        <h1 class="display"><span>Walk in as yourself.</span><span>Leave Confident.</span></h1>
        <p class="lede">More than a haircut. Three chairs, real craft and a hot towel every time. Book ahead or walk in.</p>
        <div class="cta-row">
...
<div class="marquee" aria-hidden="true"><div class="track" id="marquee"></div></div>
...
window.__BOOT__ = {
    ...
    assetBase: "{{ asset('') }}",
    api: {
        availability: "{{ route('api.availability') }}",
        bookings:     "{{ route('api.bookings') }}",
        status:       "{{ route('api.status') }}"
    }
};
</script>
<script src="{{ asset('js/ironline.js') }}?v={{ time() }}" defer></script>
</body>
</html>
